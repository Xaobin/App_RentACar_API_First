...
<card-cp title="List of brands">
    ...
    <template slot="content">
     <table-cp :dbdatas="brandsdata"
               ...
               :config="{title:'NotNullable', amountcolls: 1, refrow:'nullable',refname:'nullable',visible:true, imagefield:'Image'}"
     ></table-cp>
      </template>
    ...
    export default {
        computed: {
           ...
           titlesCP(){
               ...
               created_at:{title:'Created', ordershow:4,visible:true},
               };
                return atitles;
            }
        },
