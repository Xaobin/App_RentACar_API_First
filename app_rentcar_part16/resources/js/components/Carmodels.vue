...
*/
    export default {
      ...
      titlesCP(){
       let atitles={ id:{title:'ID', typer:'id', visible:true},
       name:{title:'Name', typer:'text',visible:true},
       image:{title:'Image', typer:'image',visible:true},
       doors:{title:'Doors', typer:'text', visible:true},
       air_bag:{title:'Air Bag', typer:'text', visible:true},
       ref_car_brand:{title:'Brand', typer:'text',visible:true},
       
               }; 
                return atitles;
            },
        configCP(){
           let configx={title:'Operations', amountcolls: 1, refrow:'ref_car_brand',refname:"name", visible:'true', typer:"last"}
        }    
        },
        data() {
            return {
